import { BotContext, ContextSource } from '@/bot/botcontext';
import { DiscordBot } from '@/bot/discordbot';
import { Display } from '@/display';
import { getEmbedUrl, replyEmbedUrl } from '@/embeds';
...
class GuildReactions {
	 ...
	 * @returns {Promise}
	 */
	async respond(m: Message<true>, rset: ReactSet) {
	 ...
	 * @returns {Promise}
	 */
	async cmdAddReact(m: Message<true>, trig: string, react: string) {
	 ...
	 * @returns {Promise}
	 */
	async cmdRmReact(m: Message<true>, trig?: string, which?: string) {
	 ...
	 * @returns {Promise}
	 */
	async cmdReactInfo(m: Message<true>, trig: string, which?: string) {
